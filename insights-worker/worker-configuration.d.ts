/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=insights-worker/wrangler.jsonc insights-worker/worker-configuration.d.ts` (hash: 8df3bdba1eb03aa1c7f9dcf9a51edce1)
