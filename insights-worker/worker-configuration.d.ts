/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=insights-worker/wrangler.jsonc insights-worker/worker-configuration.d.ts` (hash: 0bf2984e14408d84f8fc4a227ba3ea75)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_API_TOKEN">> {}
}
